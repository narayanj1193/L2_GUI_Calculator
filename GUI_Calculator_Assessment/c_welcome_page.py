...
def free_roam_click(font1=('Verdana', 30, 'bold')):
    # Clear the window
    ...
    def basic_calculator_click():
        ...
        equal_button = customtkinter.CTkButton(c_app, command=calculate, font=font1, cursor='hand2', width=640,
                                               height=75,
...
# create basic labels
welcome_jarbin_big_label = customtkinter.CTkLabel(c_app, width=403, height=48, font=('Verdana', 34, 'bold'),
...
welcome_free_roam_button = customtkinter.CTkButton(c_app, width=246, height=64, font=('Verdana', 24, 'bold'),
                                                   text='Free Roam',
                                                   text_color='white',
...
welcome_limited_calculations_button = customtkinter.CTkButton(c_app, width=435, height=64, font=('Verdana', 24, 'bold'),
...
welcome_limited_calulations_entrybox = customtkinter.CTkEntry(c_app, width=126, height=52, font=('Verdana', 20, 'bold'),
                                                              text_color='white',
                                                              corner_radius=7, bg_color='#505253')
welcome_limited_calulations_entrybox.place(relx=0.47, rely=0.412)

welcome_instructions_button = customtkinter.CTkButton(c_app, width=646, height=64,
